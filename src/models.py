...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        # self.linear = nn.Linear(512*block.expansion, num_classes) # for cifar10 (shapfed)
        self.linear = nn.Linear(512*block.expansion, 128) # embedding layer dimension for siamese network
