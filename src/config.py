...
arg.add_argument('--use_tensorboard', type=str2bool, default=False, help='whether to use tensorboard for visualization') 
...
arg.add_argument('--lambda_reg', type=float, default=0.1, help='lambda regularisation') 
...
arg.add_argument('--flag', type=int, default=1, help='Flag') 
